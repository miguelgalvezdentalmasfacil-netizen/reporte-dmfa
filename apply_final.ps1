...
async function descargarDashboardMensual(){
  ...
  try{
    ...
    function drawHeader(doc){
      ...
      doc.setFontSize(24);
      doc.text('DENTAL+F\u00C1CIL', margin, 48);
      ...
      doc.setFontSize(9);
      doc.text('Generado el '+hoy.toLocaleDateString('es-MX',{day:'2-digit',month:'long',year:'numeric'}), margin, 65);
    }
    drawHeader(doc);
...
Write-Output "Successfully updated PDF logic with UNICODE ESCAPES and BIGGER CHART!"
